...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Nouvel employé', href: '/employees/create' },
];
...
export default function EmployeeCreate() {
    ...
    const [form, setForm] = useState({
        nom: '', email: '', telephone: '', poste: 'Vendeur',
        salaire_brut: '', date_embauche: new Date().toISOString().slice(0, 10),
        cnss: '', status: 'actif',
    });
            ...
            <div className="flex flex-col gap-6 p-6 max-w-4xl">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">Ajoutez un membre à l'effectif</p>
                    </div>
                </div>
